...
export const HjelpetekstRefusjon = () => {
    return (
        <Hjelpetekst id="HjelpetekstRefusjon" type={PopoverOrientering.Under}>
            ...
            <ol>
                <li>Avklar antall dager det kan kreves refusjon for. Ta kun med dager det skulle vært utbetalt lønn for, fra og med dag 4 i arbeidsgiverperioden. Helger og helligdager kan tas med hvis de er en del av den faste arbeidstiden. Krev så refusjon fra og med dag 4, men maksimalt 13 dager til sammen. Dager før 16. mars får du ikke refusjon for.</li>
            ...
            <h3>Eksempel:</h3>
            <ol>
                <li>Frida har første fraværsdag 20. mars. Hun jobber mandag-fredag og får ikke utbetalt lønn for helgedager. Arbeidsgiverperioden går til og med 4. april. Trekk fra helgedager og de tre første dagene i arbeidsgiverperioden = 10 dager som det kan kreves refusjon for.</li>
