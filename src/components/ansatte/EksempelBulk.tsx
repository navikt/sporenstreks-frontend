...
const Sprsml = () => (<svg className="hjelpetekst__ikon" width="32" height="32" focusable="false" viewBox="0 0 18.2 18.2" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="eksempel-bulk">
      ...
      >
        ...
        >
          ...
          2. Beregn månedsinntekten slik det ellers gjøres for sykepenger i arbeidsgiverperioden.<br/>
          3. Gang med 12 måneder for å finne årslønn.<br/>
          4. Reduser beløpet til 6G (=599 148) hvis beløpet er over dette.<br/>
          5. Finn dagsatsen ved å dele årslønnen på antall dager dere utbetaler lønn for i året.<br/><br/>
