...
describe('validateNotNullAndPositive', () => {
  ...
  it('should return "EnkelDager må være positivt" when we have zero as number', () => {
    const input: number = 0;
    const expected = 'EnkelDager må være positivt';
  ...
  it('should return "EnkelDager må være positivt" on negative number', () => {
