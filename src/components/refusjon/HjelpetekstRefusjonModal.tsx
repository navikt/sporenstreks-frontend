  ...
  return (
    ...
    >
      <Veilederpanel svg={VeilederIkon}>
        ...
        <br />
        (Merk: Beløpet er før skatt, og det skal være uten feriepenger og
        arbeidsgiveravgift. Det beregnes feriepenger av det NAV refunderer. Dere
        får utbetalt refusjonen av feriepengene neste år)
        <br />
        <ol>
          <li>
          ...
          <li>
            ...
            faste arbeidstiden. Dager før 1. desember får du ikke refusjon for.
          </li>
          <li>
          ...
          <li>
            Finn dagsatsen ved å dele årslønnen på antall dager dere utbetaler
            lønn for i året.
          </li>
        ...
        <ol>
          <li>
            Frida har første fraværsdag 20. januar. Hun jobber mandag-fredag og
            får ikke utbetalt lønn for helgedager. Arbeidsgiverperioden går til
            og med 4. februar. Start å telle på den sjette i
          ...
          <li>
            ...
            desember. I dette eksempelet har Frida en snittlønn på 55 000 kroner
