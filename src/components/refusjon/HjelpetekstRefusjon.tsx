    ...
    <div className='hjelpetekst-refusjon'>
      ...
      >
        <Veilederpanel svg={VeilederIkon}>
          ...
          arbeidsgiveravgift. Det beregnes feriepenger av det NAV refunderer.
          Dere får utbetalt refusjonen av feriepengene neste år)
          <br />
          <ol>
            <li>
          ...
          <button
            ...
            onClick={(evt) => handleCloseButton(evt)}
          >
            Lukk dette vinduet
          </button>
        </Veilederpanel>
