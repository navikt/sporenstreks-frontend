...
describe('LoggetUtAdvarsel', () => {
  it('should not display anything if the token is valid', () => {
    render(<AppStoreProvider tokenExpired={false}><LoggetUtAdvarsel/></AppStoreProvider>);
  ...
  it('should display the modal if the token is invalid', () => {
    render(<AppStoreProvider tokenExpired={true}><LoggetUtAdvarsel/></AppStoreProvider>);
